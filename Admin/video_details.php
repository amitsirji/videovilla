	...
	<div id="container">
		<div id="content">
			<?php
				...
				$query = "select * from videos where userid=$uid";
				...
				if(mysqli_num_rows($result)) {
					while($row = mysqli_fetch_array($result))
					{
						...
						echo "<br>";
						echo "<b style='color:blue;'>".explode(".",$videoname)[0]."</b>";
						echo "<br>";
						echo "<br><a href='video_details.php?action=delete & vid=$videoid & uid=$uid'>Delete</a>";
						$count++;		
					}
				}
				else
