			...
			if(isset($_POST['submit']))
			{
				...
				else 
				{
					...
					*/	
					...
					//$ffmpeg = "C:\\xampp\\htdocs\\videovilla\\ffmpeg\\bin\\ffmpeg";
					...
					{							
						...
						$insert = "insert into videos (userid,videoid,usernm,videoname,description,category,vidpath,imgpath,type,size) values ($uid,$v_id,'$usernm','$name','$desc','$cat','$target_dir','$imgpath','$type',$size)";
						//echo $insert;
